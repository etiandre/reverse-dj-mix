...
#slide(title: "Mise sous forme matricielle")[
  #side-by-side[
    #figure(
      [#image("../2024-04-26/nmf-djmix.png", height: 70%)],
      caption: [
...
#slide(title: [Estimation du _warp_])[
  #figure(
    [#image("../2024-04-26/results/boucles/out.png")],
    caption: [
...
#slide(title: [Estimation du _warp_])[
  #figure(
    [#image("../2024-04-26/results/timestretch/out.png")],
    caption: [
...
#slide(title: [Estimation du gain])[
  #figure(
    [#image("../2024-04-26/results/fondu/out.png")],
    caption: [
...
#slide(title: [Structure de $bold(H)$])[
  #figure(
    image("../2024-05-30/resultat.png"),
    caption: [indéterminations liés au décalage des trames des spectrogrammes],
  )
]
#slide(title: [Structure de $bold(H)$])[
